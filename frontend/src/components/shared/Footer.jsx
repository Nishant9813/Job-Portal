    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          <h2 className="text-xl font-bold">F <span className='text-red-600'>Portal</span></h2>
          <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
        </div>
        
        <div className="flex space-x-4 mt-4 md:mt-0">
          <a href="https://facebook.com" target='_blank' className="hover:text-gray-400 text-red-500" aria-label="Facebook">
          ...
          <a href="https://twitter.com" target='_blank' className="hover:text-gray-400 text-red-500" aria-label="Twitter">
          ...
          <a href="https://linkedin.com" target='_blank' className="hover:text-gray-400 text-red-500" aria-label="LinkedIn">
